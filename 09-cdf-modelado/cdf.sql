...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `casadelfuturo`.`categoria` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `casadelfuturo`.`modulos` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `casadelfuturo`.`cursos` ;
...
CREATE TABLE IF NOT EXISTS `casadelfuturo`.`cursos` (
  ...
  PRIMARY KEY (`id`, `categoria_id`, `modulos_id`),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `casadelfuturo`.`rol` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `casadelfuturo`.`domicilio` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `casadelfuturo`.`usuario` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `casadelfuturo`.`cursos_usuario` ;
